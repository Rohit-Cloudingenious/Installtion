...
import getGenralisedData from '@salesforce/apex/InstallerDetailFormController.getGenralisedData';
...
export default class InstallerGenChecklist extends NavigationMixin (LightningElement) {
    ...
    handleDisplayChecklist(checklist) {
        getGenralisedData({recId: this.recordId, checklistSection: checklist})
        .then(result => {
